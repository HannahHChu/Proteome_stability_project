...
summary(fit)
```
The ANOVA doesn't indicate a relationship between the different lines and KD temperature. The only significant variable is KD temperature, which means we can reject the null hypothesis that there are equal means for KD temperature.
