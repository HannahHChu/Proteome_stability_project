...
# lets set up a model to determine sex effects speficialyl regardless of strain
mmod3<-lmer(formula=scaled~treatment*sex+(1|cohort)+(1|strain),data=dat6)
summary(mmod3)

ggplot(dat6,aes(x=sex,y=scaled))+geom_boxplot()+ylab("Overall Scaled Thermal Hardiness")
